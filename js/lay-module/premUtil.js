...
layui.define(['jquery', 'form'], function (exports) {
    ...
    if (loginUser !== null && btnPermission !== null) {
        authList = loginUser.btnPermission;
    }
    ...
    var premUtil = {
            ...
            if (loginUser !== null && loginUser !== undefined) {
                if (loginUser.adminType !== 1) {
                    $('[perm-show]').each(function () {
                        if (!premUtil.hasPerm($(this).attr('perm-show'))) $(this).remove();
                    });
                }
            }
        },
         ...
         * @param 字典值编码
         */
        rendDataTableDict: function (dictTypeCode, dictCode) {
            var result = '未知';
            var dictData = layui.data("layui").dictData;
        ...
        rendDictDropDown: function (filterName, fieldName, dictTypeCode, placeholderName, exclude) {
            ...
            return formX.renderSelect({
                elem: elem,
                data: premUtil.getDictDataByDictTypeCode(dictTypeCode, exclude),
                name: 'name',
                value: 'code',
        ...
        handleNoChildrenZtreeData: function (data) {
            data.forEach(function (value) {
                if (value.children.length === 0) {
                    ...
                    premUtil.handleNoChildrenZtreeData(value.children);
                }
            })
            return data;
        },
        ...
        handleZtreeDataSpread: function (data) {
            data.forEach(function (value) {
                if (value.children.length !== 0) {
                    value.spread = true;
                    premUtil.handleZtreeDataSpread(value.children);
                }
            })
            return data;
        },
        ...
        handleZtreeDataOpen: function (data) {
            data.forEach(function (value) {
                if (value.children.length !== 0) {
                    value.open = true;
                    premUtil.handleZtreeDataOpen(value.children);
                }
            })
            return data;
        },
